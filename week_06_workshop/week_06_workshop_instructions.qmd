...
1.  **Create a promotional flyer** for our course showcase using **Ideogram** for image generation and **Canva** for final editing. (You're encouraged to embed this on your website, and share this flyer with colleagues and friends to get them to come to the showcase. **Note**: If you invite friends to attend the final showcase, it's your responsibility to provide them with the workshop passcode and consider sending them a calendar invitation with the event details.)
...
1.  In the prompt box, describe the image you want to create. You can copy and paste the recommended prompt below, or write your own. Remember to replace `[YOUR WEBSITE NAME HERE]` with your website's name and customize the theme colors if you'd like. For color inspiration, check out [coolors.co](https://coolors.co/){target="_blank"}. Feel free to experiment with other aspects of the prompt.
...
![Ideogram edit button](images/ideogram_edit_button.jpg){width="427"}
