...
2. **Create a New Bot:**
   ...
   - Skip the initial bot-creation flow. (Select "Other" for the bot type, then "Next" at the next two screens.)
   - Find the button to "Open the bot in studio" and click it
