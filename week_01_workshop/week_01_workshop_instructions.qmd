...
## Give ChatGPT the course information and your CV and ask it to build a portfolio website

-   Download the course brochure from [thegraphcourses.org/aiw](https://thegraphcourses.org/aiw).

-   Go to [chatgpt.com](https://chatgpt.com). Make sure you are logged in, as this allows you to acces more advanced models. If you have a paid ChatGPT account select the "Thinking" model. Otherwise, leave the default model.
...
-   Start a new message and create an instruction similar to this:
    ...
    Site should be beautiful and rich with beautiful styling, gradients and sections.
