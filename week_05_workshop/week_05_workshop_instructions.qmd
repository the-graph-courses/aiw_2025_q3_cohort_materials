...
# Part 5: Adding Email Notifications (Optional but Recommended)

## Set Up Resend Email Service

Sending emails from your automations is often useful but not required for this workshop. If you'd like to receive email notifications when new reports are generated, follow these steps:

In an ideal case, you can connect your own email directly to the make.com service and draft and send emails from your account using your automations.
...
5.  Configure the email settings:
    ...
    -   **HTML content:** Add the AI response content variable from OpenRouter (same as used in Google Docs)
6.  Click **Save**
...
# Part 6: Activating Your Automation
...
(Note that if you want to test the full functionality, after embedding the form in your website, you may want to set the frequency to 2 minutes or less, so you can see the results immediately.)

------------------------------------------------------------------------

# Part 7: Embedding the Form in Your Website
